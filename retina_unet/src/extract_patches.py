...
from retina_unet.src.help_functions import load_hdf5
from retina_unet.src.help_functions import visualize
from retina_unet.src.help_functions import group_images
...
def get_data_training(DRIVE_train_imgs_original,
    ...
    print("train PATCHES images/masks shape:")
...
#Load the original data and return the extracted patches for training/testing
def get_data_testing(DRIVE_test_imgs_original, DRIVE_test_groudTruth, Imgs_to_test_from,Imgs_to_test_to, patch_height, patch_width):
    ### test
    ...
    test_imgs = test_imgs[0:Imgs_to_test_to-Imgs_to_test_from,:,:,:]
    test_masks = test_masks[0:Imgs_to_test_to-Imgs_to_test_from,:,:,:]
    ...
    print("test PATCHES images/masks shape:")
...
def get_data_testing_overlap(DRIVE_test_imgs_original, DRIVE_test_groudTruth, Imgs_to_test_from,Imgs_to_test_to, patch_height, patch_width, stride_height, stride_width):
    ### test
    test_imgs_original = load_hdf5(DRIVE_test_imgs_original)
    test_masks = load_hdf5(DRIVE_test_groudTruth)
    ...
    print("test PATCHES images shape:")
    print(patches_imgs_test.shape)
    print("test PATCHES images range (min-max): " +str(np.min(patches_imgs_test)) +' - '+str(np.max(patches_imgs_test)))
